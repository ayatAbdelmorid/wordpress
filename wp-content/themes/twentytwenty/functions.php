...
function create_custom_post_type() {
	...
	$labels = array(
	'name' => _x('Custom Posts', 'plural'),
	'singular_name' => _x('Custom Post', 'singular'),
	'menu_name' => _x('custom posts', 'admin menu'),
	'name_admin_bar' => _x('custom post', 'admin bar'),
	'add_new' => _x('Add New post', 'add new'),
	...
	'not_found' => __('No custom post found.'),
	);
	$args = array(
	'supports' => $supports,
	'labels' => $labels,
